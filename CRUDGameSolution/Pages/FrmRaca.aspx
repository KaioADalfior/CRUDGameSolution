...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="max-width: 860px; margin: 0 auto;">
        ...
        <%-- Cabeçalho --%>
        <div class="rpg-page-title">🌍 Gerenciar Raças</div>
        <p class="rpg-page-subtitle">Forje as origens dos heróis e criaturas do seu mundo</p>
        ...
        <%-- Card Formulário --%>
        <div class="rpg-card">
            <div class="rpg-section-title">✦ Nova Raça</div>
            <div class="row">
                <div class="col-sm-8">
                    <div class="form-group" style="margin-bottom:0;">
                        <label class="rpg-label">Nome da Raça</label>
                        <asp:TextBox
                            runat="server"
                            ID="txtDescricao"
                            CssClass="rpg-input"
                            placeholder="Ex: Elfo, Anão, Tiefling, Draconato..." />
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group" style="margin-bottom:0;">
        ...
        <%-- Card Tabela --%>
        <div class="rpg-card">
            <div class="rpg-section-title">📜 Raças Cadastradas</div>
                ...
                <table class="rpg-table">
                    ...
                    <tbody>
                        <asp:ListView runat="server" ID="lvRacas">
                            <ItemTemplate>
                                <tr>
                                    <td class="col-id"><%# Eval("idRaca") %></td>
                                ...
                                <tr>
                                    <td colspan="3">
                                        <div class="rpg-empty">
                                            ...
                                            <p>Nenhuma raça forjada ainda.</p>
                                        </div>
                                    </td>
                                </tr>
                            </EmptyDataTemplate>
