...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="max-width: 860px; margin: 0 auto;">
        ...
        <%-- Cabeçalho --%>
        <div class="rpg-page-title">📚 Gerenciar Classes</div>
        <p class="rpg-page-subtitle">Defina os caminhos que os heróis podem trilhar</p>
        ...
        <%-- Card Formulário --%>
        <div class="rpg-card">
            <div class="rpg-section-title">✦ Nova Classe</div>
            <div class="row">
                <div class="col-sm-8">
                    <div class="form-group" style="margin-bottom:0;">
                        <label class="rpg-label">Nome da Classe</label>
                        <asp:TextBox
                            runat="server"
                            ID="txtDescricao"
                            CssClass="rpg-input"
                            placeholder="Ex: Guerreiro, Mago, Ladino, Paladino..." />
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group" style="margin-bottom:0;">
        ...
        <%-- Card Tabela --%>
        <div class="rpg-card">
            <div class="rpg-section-title">📜 Classes Cadastradas</div>
                ...
                <table class="rpg-table">
                    ...
                    <tbody>
                        <asp:ListView runat="server" ID="lvClasses">
                            <ItemTemplate>
                                <tr>
                                    <td class="col-id"><%# Eval("idClasse") %></td>
                                ...
                                <tr>
                                    <td colspan="3">
                                        <div class="rpg-empty">
                                            ...
                                            <p>Nenhuma classe registrada ainda.</p>
                                        </div>
                                    </td>
                                </tr>
                            </EmptyDataTemplate>
