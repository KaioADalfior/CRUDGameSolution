    ...
    <div class="container-fluid" style="max-width: 860px;">
        ...
        <div class="page-header" style="border-color:#2a2a3e;">
            <h1 style="color:#c9a84c;">
                <span class="glyphicon glyphicon-th-list"></span> Gerenciar Subclasses
            </h1>
        </div>
        ...
        <div class="panel" style="background-color:#1e1e2e; border-color:#c9a84c;">
            <div class="panel-heading" style="background-color:#c9a84c; border-color:#c9a84c;">
                <h3 class="panel-title" style="color:#1a1a2e; font-weight:bold;">
                    <span class="glyphicon glyphicon-plus-sign"></span> Criar Nova Subclasse
                </h3>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="txtDescricao" style="color:#aaaaaa;">Nome da Subclasse</label>
                            <asp:TextBox
                                runat="server"
                                ID="txtDescricao"
                                CssClass="form-control"
                                placeholder="Ex: Paladino, Necromante, Assassino..."
                        ...
                        <asp:ListView runat="server" ID="lvSubclasses">
                            <ItemTemplate>
                                <tr style="border-color:#2a2a3e;">
                                    <td style="border-color:#2a2a3e; color:#aaaaaa;"><%# Eval("idSubclasse") %></td>
                                    <td style="border-color:#2a2a3e; color:#e0e0e0;"><%# Eval("Descricao") %></td>
                                    <td style="border-color:#2a2a3e; color:#e0e0e0;"><%# Eval("Classes.Descricao") %></td>
                            ...
                            <EmptyDataTemplate>
                                <tr>
                                    <td colspan="4" class="text-center" style="padding:20px; color:#555; border-color:#2a2a3e;">
                                        <span class="glyphicon glyphicon-info-sign"></span> Nenhuma subclasse cadastrada ainda.
                                    </td>
                                </tr>
                            </EmptyDataTemplate>
                        </asp:ListView>
